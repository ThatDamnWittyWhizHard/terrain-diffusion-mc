 ...
 *
 * <p>The short IDs are an internal wire format stored in generated heightmap tiles. Existing
 * IDs are intentionally preserved to keep old cached tiles and Python parity readable.</p>
 */
public final class BiomePalette {
    ...
    // Vanilla surface biomes added to the classifier palette.
    ...
    public static final short WOODED_BADLANDS = 27;
    public static final short ERODED_BADLANDS = 28;
    public static final short CHERRY_GROVE = 30;
    public static final short JAGGED_PEAKS = 34;
    public static final short FROZEN_RIVER = 36;
    public static final short RIVER = 37;
    ...
    public static final short PALE_GARDEN = 51;
